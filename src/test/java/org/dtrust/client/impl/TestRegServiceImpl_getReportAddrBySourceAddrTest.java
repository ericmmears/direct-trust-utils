...
public class TestRegServiceImpl_getReportAddrBySourceAddrTest
{
	...
	abstract class TestPlan extends BaseTestPlan 
	{
		...
		{			
			...
			Collection<TestRegistration> regs = service.getReportAddrBySourceAddr(reg.getSourceDirectAddress());
			
			doAssertions(regs);
		}
		
		protected void doAssertions(Collection<TestRegistration> regs) throws Exception
		{
	...
	public void testAddReg_assertAdded() throws Exception
	{
		new TestPlan()
		{
			...
			protected void doAssertions(Collection<TestRegistration> regs) throws Exception
			{
				...
				final TestRegistration reg = regs.iterator().next();
